...
const Footer = () => {
    return (
        <div className="w-full h-screen flex justify-between pt-24 pb-10 px-16 font-grotesk bg-zinc-900">
            <div className="w-1/2 h-full flex flex-col justify-between text-[8.5vw] leading-[6.5vw] font-semibold uppercase">
            ...
            <div className="w-1/2">
                <h1 className="text-[8.5vw] leading-[6.5vw] font-semibold uppercase">
                    presentations
                </h1>

                <div className="linkscontainer flex flex-col gap-8 text-zinc-300 font-neue font-light leaidng-0 mt-10">
                    <div className="flex flex-col gap-3">
                        ...
                        <div className="flex flex-col">
                            {[
                                ...
                                <a
                                    className="cursor-pointer underline hover:text-[#CDEA68] transition-colors duration-300"
                                    key={i}
                                >
                                    {item}
                                </a>
                    ...
                    <div className="flex flex-col gap-4 -mt-10">
                        ...
                        <a className="cursor-pointer underline hover:text-[#CDEA68] transition-colors duration-300">
                            hello@ochi.design
                        </a>
                    </div>
                </div>
