...
const Eyes = () => {
    ...
    return (
        <div className="eyes w-full h-screen overflow-hidden">
            <div data-scroll data-scroll-section data-scroll-speed='-.4' className="relative w-full h-screen bg-[url('./eyes-bg.jpg')] bg-cover bg-center bg-no-repeat">
                <div data-scroll data-scroll-section data-scroll-speed='-.05' className="absolute flex gap-10 top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%]">
